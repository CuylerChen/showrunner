...
|------|------|------|
| 免费 | $0 | 注册后首次免费 1 次 |
| Starter | $19.9 / 月 | 10 次 / 月 |
| Pro | $59.9 / 月 | 无限次 + 分镜人物声音 |

**付费触发节点**
用户注册后生成第一个 Demo（免费），结果页出现订阅引导。
用户无额度时，点击生成后创建 Creem Hosted Checkout 并跳转到结账页。

**订阅工具**：Creem Billing（Hosted Checkout + Webhook 同步本地额度）
