    ...
    <div className="relative min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--bg-base)' }}>
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="glass-card rounded-2xl p-8" style={{ boxShadow: '0 8px 48px rgba(0,0,0,0.6)' }}>
          <h1 className="text-xl font-bold mb-1" style={{ color: 'var(--text-primary)' }}>创建账号</h1>
          <p className="text-sm mb-6" style={{ color: 'var(--text-muted)' }}>免费开始，无需信用卡</p>
        ...
        <p className="mt-5 text-center text-sm" style={{ color: 'var(--text-muted)' }}>
          已有账号？{' '}
          <Link href="/sign-in" className="font-medium transition-colors hover:opacity-80"
            style={{ color: '#818CF8' }}>
            登录
          </Link>
        </p>
