    ...
    pricingPlans: [
      {
        ...
        period: 'forever',
        quota: '1 video',
        description: 'Best for validating the product video workflow.',
        features: ['1 free video credit', 'AI storyboard and narration', 'Public share page'],
      },
      {
        name: 'Starter',
        price: '$19',
        ...
        description: 'Best for steady product promo video production.',
        features: ['10 videos per month', 'Full video generation flow', 'Shareable video page'],
        highlighted: true,
      },
      {
        name: 'Pro',
        ...
        description: 'Best for teams producing ongoing marketing assets.',
        features: ['Unlimited video generation', 'Brand customization', 'Built for multiple product lines'],
      },
    ],
