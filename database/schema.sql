...
CREATE TABLE IF NOT EXISTS subscriptions (
  ...
  creem_customer_id     VARCHAR(64)                           NULL,
  creem_subscription_id VARCHAR(64)                           NULL,
  creem_product_id      VARCHAR(64)                           NULL,
  creem_status          VARCHAR(40)                           NULL,
  creem_updated_at      TIMESTAMP                             NULL,
  created_at            TIMESTAMP                             NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at            TIMESTAMP                             NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Creem webhook event idempotency
