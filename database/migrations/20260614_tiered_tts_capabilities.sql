-- Add tiered TTS voice selection fields.
...
CALL showrunner_add_column_if_missing('demos', 'tts_voice_id', 'tts_voice_id VARCHAR(40) NOT NULL DEFAULT ''default'' AFTER brand_tone');
CALL showrunner_add_column_if_missing('demos', 'tts_speed', 'tts_speed INT NOT NULL DEFAULT 100 AFTER tts_voice_id');
CALL showrunner_add_column_if_missing('steps', 'tts_voice_id', 'tts_voice_id VARCHAR(40) NULL AFTER narration');
